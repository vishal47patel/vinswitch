...
Route::middleware(['auth'])->group(function () {
    ...
    // tenent list (customers) page 
    Route::get('/customers', [TenantController::class, 'customers'])->name('customers');
    Route::post('/customer_add_ajax', [TenantController::class, 'customer_add_ajax']);
    Route::post('/customer_cred_add_ajax',[TenantController::class, 'customer_cred_add_ajax']);
    Route::get('/billplan_get_on_type', [TenantController::class, 'billplan_get_on_type']);
    Route::post('/customer_bill_plan_add_ajex', [TenantController::class, 'customer_bill_plan_add_ajex']);
